  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
     ...
     <?php include("../admin/include/sidebar.php");?>
      ...
      <main class="app-main">
        ...
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            <!--begin::Row-->
            <div class="col-sm-6"><h3 class="mb-3">เเสดง Dashbord</h3></div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">กราฟจำนวนผู้เช็คอินตามช่วงเวลา</h6>
      ...
      <script src="../admin/js/chart-area3-demo.js"></script>
      <script src="../admin/js/chart-pie3-demo.js"></script>
